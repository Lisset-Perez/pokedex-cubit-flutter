...
import 'package:pokedex_cubit/screens/pokemon_screen.dart';

void main() {
  runApp(MyApp(repo: PokemonRepository()));
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'PokeAPI Cubit Demo',
      home: BlocProvider(
        create: (_) => PokemonCubit(repo)..fetchPokemons(),
